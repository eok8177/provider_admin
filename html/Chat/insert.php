...
<a href="#" onClick="sp('[m1]');return false"><img src="pics/m1.gif" alt="<?php print "$crl[8]";?>" border="0"></a>
<a href="#" onClick="sp('[m2]');return false"><img src="pics/m2.gif" alt="<?php print "$crl[9]";?>" border="0"></a>
<a href="#" onClick="sp('[m3]');return false"><img src="pics/m3.gif" alt="<?php print "$crl[10]";?>" border="0"></a>
<a href="#" onClick="sp('[m4]');return false"><img src="pics/m4.gif" alt="<?php print "$crl[11]";?>" border="0"></a>
<a href="#" onClick="sp('[m5]');return false"><img src="pics/m5.gif" alt="<?php print "$crl[12]";?>" border="0"></a>
<a href="#" onClick="sp('[m6]');return false"><img src="pics/m6.gif" alt="<?php print "$crl[13]";?>" border="0"></a>
